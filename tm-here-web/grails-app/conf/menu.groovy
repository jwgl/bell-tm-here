menuGroup 'main', {
    process 20, {
        ...
        courseClassAttendances 11, 'PERM_ROLLCALL_WRITE',          '/web/here/teachers/${userId}/courseClasses'
        attendanceList         12, 'PERM_ATTENDANCE_LIST',         '/web/here/attendances'
        attendanceItem         13, 'PERM_ATTENDANCE_ITEM',         '/web/here/students/${userId}/attendances'
        ...
        departmentExamDisqual  41, 'PERM_EXAM_DISQUAL_DEPT_ADMIN', '/web/here/departments/${departmentId}/disquals'
    }
}